...
import com.control.Manager;
import com.log.ConsoleLogger;
import com.trafficlights.EnglishTrafficLightsFactory;
import com.trafficlights.JapaneseTrafficLightsFactory;
import com.trafficlights.RussianTrafficLightsFactory;
import com.trafficlights.virtual.AbstractFactory;
import java.io.IOException;

public class Main {

    // TODO: move text below to readme
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            AbstractFactory factoryJA = new JapaneseTrafficLightsFactory();
            AbstractFactory factoryEN = new EnglishTrafficLightsFactory();
            AbstractFactory factoryRU = new RussianTrafficLightsFactory();
            
            Manager mngr = new Manager();
            
            // adding some number of arbitrary traffic lights
            mngr.addTrafficLights(factoryRU.createTrafficLights());
            mngr.addTrafficLights(factoryEN.createTrafficLights());
            mngr.addTrafficLights(factoryRU.createTrafficLights());
            mngr.addTrafficLights(factoryJA.createTrafficLights());
            
            // set logging to console
            mngr.addLogger(ConsoleLogger.getInstance());
